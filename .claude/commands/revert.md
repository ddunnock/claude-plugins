...
Resolve spec gaps that caused implementation failure.

Use: `/clarify`

### Revise Plan
Update plan with a different approach based on learnings.

Use: `/plan`

### Retry Implementation
Retry implementation after fixes are in place.
