...
/clarify --ralph              # Autonomous mode (ralph-loop enabled)
```
...
- `python.md` - Python standards, type hints, Pyright strict
...
**Active lenses for this project (MCP Server / API Backend):**
...
- [x] **Mismatches**: Requirements ↔ design gaps
- [ ] **Stakeholders**: Operator, security, end-user perspectives (lightweight for MCP)
