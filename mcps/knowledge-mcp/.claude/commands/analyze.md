...
**Directive Authority**: The project directives in `.claude/memory/` are **non-negotiable**. Directive conflicts are automatically CRITICAL and require adjustment of the spec, plan, or tasks.
...
- `python.md` - Python standards, Pyright strict, ruff, Google-style docstrings
