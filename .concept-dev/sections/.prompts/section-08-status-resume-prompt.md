...
Generate content for section `section-08-status-resume` (filename: `section-08-status-resume.md`).
...
for `section-08-status-resume` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-08-status-resume.md`
