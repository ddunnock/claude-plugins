...
Generate content for section `section-12-decomposition` (filename: `section-12-decomposition.md`).
...
for `section-12-decomposition` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-12-decomposition.md`
