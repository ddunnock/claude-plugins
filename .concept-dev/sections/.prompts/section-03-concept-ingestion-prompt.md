...
Generate content for section `section-03-concept-ingestion` (filename: `section-03-concept-ingestion.md`).
...
for `section-03-concept-ingestion` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-03-concept-ingestion.md`
