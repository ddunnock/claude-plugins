...
Generate content for section `section-06-requirements-engine` (filename: `section-06-requirements-engine.md`).
...
for `section-06-requirements-engine` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-06-requirements-engine.md`
