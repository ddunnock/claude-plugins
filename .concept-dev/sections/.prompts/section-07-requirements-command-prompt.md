...
Generate content for section `section-07-requirements-command` (filename: `section-07-requirements-command.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/dunnock/projects/claude-plugins/.concept-dev/claude-plan.md` - Full implementation plan
2. `/Users/dunnock/projects/claude-plugins/.concept-dev/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/dunnock/projects/claude-plugins/.concept-dev/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-requirements-command` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-07-requirements-command.md`
