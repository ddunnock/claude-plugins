...
Generate content for section `section-02-state-management` (filename: `section-02-state-management.md`).
...
for `section-02-state-management` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-02-state-management.md`
