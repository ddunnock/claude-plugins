...
Generate content for section `section-05-quality-checker` (filename: `section-05-quality-checker.md`).
...
for `section-05-quality-checker` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-05-quality-checker.md`
