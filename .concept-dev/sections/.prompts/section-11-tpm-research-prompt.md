...
Generate content for section `section-11-tpm-research` (filename: `section-11-tpm-research.md`).
...
for `section-11-tpm-research` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-11-tpm-research.md`
