...
Generate content for section `section-04-needs-tracker` (filename: `section-04-needs-tracker.md`).
...
for `section-04-needs-tracker` to understand what this section should contain.
...
`/Users/dunnock/projects/claude-plugins/.concept-dev/sections/section-04-needs-tracker.md`
